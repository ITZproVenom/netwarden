...
export type Device = { ip: string; mac: string; name: string; vendor: string; role: string; firstSeen: string; lastSeen: string; online: boolean; controlState: DeviceControlState }
